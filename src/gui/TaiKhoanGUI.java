...
public class TaiKhoanGUI extends JFrame {
    ...
    private void seedSampleData() {
        ...
        allAccounts.add(new AccountRecord("ketoan01", "Phạm Khôi", "Kế toán", "Hoạt động", "09/03/2026 08:10", "ketoan01@hotel.com", "Phụ trách đối soát hóa đơn và báo cáo cuối ngày", true, false, false, true, false, false, true, false));
        allAccounts.add(new AccountRecord("quantri", "Lê My", "Quản trị", "Hoạt động", "09/03/2026 06:40", "admin@hotel.com", "Toàn quyền hệ thống", true, true, true, true, true, true, true, true));
